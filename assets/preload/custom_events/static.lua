-- Event notes hooks
function onCreate()
	makeAnimatedLuaSprite('sussyStatic', 'effects/Phase3Static', 0, 0)
	...
	scaleObject('sussyStatic', 2.8, 2.8)
	setObjectCamera('sussyStatic', 'game')
	setScrollFactor('sussyStatic',0,0)
