...
function onCreate()
	...
	makeLuaText('CODER1', 'shilzzz', 1000, 132, -1000) --Team Member Helping Name Here--
	setTextAlignment('CODER1', 'center')
	setTextSize('CODER1', 25)
	setObjectCamera('CODER1', 'other')
	addLuaText('CODER1')
	
	makeLuaText('ARTIST1', 'Daniman099', 1000, 132, -1000) --Team Member Helping Name Here--
	setTextAlignment('ARTIST1', 'center')
	setTextSize('ARTIST1', 25)
	setObjectCamera('ARTIST1', 'other')
	addLuaText('ARTIST1')
	
	makeLuaText('MUSICIAN1', 'The_Dark_Lord5', 1000, 132, -1000) --Team Member Helping Name Here--
	setTextAlignment('MUSICIAN1', 'center')
	setTextSize('MUSICIAN1', 25)
	setObjectCamera('MUSICIAN1', 'other')
	addLuaText('MUSICIAN1') 
	
	makeLuaText('CHARTER1', 'happi_grunt', 1000, 132, -1000) --Team Member Helping Name Here--
